                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <div class="card-body">
                                ...
                                <?php
                                  ...
                                  if (@$_GET['register'] == 'sukses') {
                                    echo '<p class="border border-success p-3 white-text">Register Berhasil, silahkan login</p>';
                                }
                                ...
                                <div class="text-center">
                                    ...
                                    <hr>
                                    <a href="<?=$konfig['url']?>register.php" class="btn primary-color btn-lg white-text">Register</a>
                                </div>
