...
<!--Main layout-->
      ...
      <div class="container-fluid">
                    ...
                    <div class="modal-body">
                       <form id="forminput">
                              <div class="md-form mb-5">
                                  <input type="text" id="gejala" name="gejala" class="form-control" required autofocus>
                                  <label>Gejala</label>
        ...
        <div class="modal-dialog modal-lg" role="document">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="formupdate">
                              <input type="hidden" id="editid_gejala" name="id_gejala">
                              <div class="md-form mb-5">
                                  <input type="text" id="editgejala" name="gejala" class="form-control" required autofocus>
                                  <label>Gejala</label>
                                  <div class="invalid-feedback">
                                    Tolong Diisi.
                                  </div>
    ...
    <script>
      $('#tabel').load('aksi/gejala/tabel.php');

      function editdata(value) {
      $.get('aksi/gejala/aksi.php?i=select&id='+value, function(data, status){
        if (data.status == 'sukses') {
            $('#editid_gejala').val(value);
            $('#editgejala').val(data.gejala);
          }
        });
  ...
  $(document).ready(function(){
    ...
    $('#forminput').on('submit', function (e) {
                  ...
                  $.ajax({
                     type: "POST",
                     url: "aksi/gejala/aksi.php?i=input",
                     dataType: "json",
                     data: datas
                  }).done(function( data ) {
                    if (data.status == 'sukses') {
    ...
    $('#formupdate').on('submit', function (e) {
                  ...
                  $.ajax({
                     type: "POST",
                     url: "aksi/gejala/aksi.php?i=update",
                     dataType: "json",
                     data: datas
                  }).done(function( data ) {
                    if (data.status == 'sukses') {
  ...
  function deletedata(str){
    ...
    showLoaderOnConfirm: true,
        ...
        $.ajax({
           type: "POST",
           dataType: "json",
           url: "aksi/gejala/aksi.php?i=delete&id="+id
        }).done(function( data ) {
          if (data.status == 'sukses') {
          swal({
          type: 'success',
