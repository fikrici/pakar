...
<!--Main layout-->
                    ...
                    <div class="modal-body">
                       <form id="forminput">
                              <div class="md-form mb-5">
                                  <input type="text" id="kepastian" name="kepastian" class="form-control" required autofocus>
                                  <label>Kepastian</label>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="formupdate">
                              ...
                              <div class="md-form mb-5">
                                  <input type="text" id="editkepastian" name="kepastian" class="form-control" required autofocus>
                                  <label>Kepastian</label>
                                  <div class="invalid-feedback">
                                    Tolong Diisi.
                                  </div>
    ...
    <script>
      $('#tabel').load('aksi/kepastian/tabel.php');

      function editdata(value) {
      $.get('aksi/kepastian/aksi.php?i=select&id='+value, function(data, status){
        if (data.status == 'sukses') {
            $('#editid').val(value);
            $('#editkepastian').val(data.kepastian);
          }
        });
  ...
  $(document).ready(function(){
    ...
    $('#forminput').on('submit', function (e) {
                  ...
                  $.ajax({
                     type: "POST",
                     url: "aksi/kepastian/aksi.php?i=input",
                     dataType: "json",
                     data: datas
                  }).done(function( data ) {
                    if (data.status == 'sukses') {
    ...
    $('#formupdate').on('submit', function (e) {
                  ...
                  $.ajax({
                     type: "POST",
                     url: "aksi/kepastian/aksi.php?i=update",
                     dataType: "json",
                     data: datas
                  }).done(function( data ) {
                    if (data.status == 'sukses') {
  ...
  function deletedata(str){
    ...
    showLoaderOnConfirm: true,
        ...
        $.ajax({
           type: "POST",
           dataType: "json",
           url: "aksi/kepastian/aksi.php?i=delete&id="+id
        }).done(function( data ) {
          if (data.status == 'sukses') {
          swal({
          type: 'success',
